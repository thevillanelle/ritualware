  ...
  return (
    <div style={{ marginTop: '1.5rem' }}>
      <button onClick={() => setOpen(o => !o)}
        ...
        className="font-mono text-xs tracking-widest hover:opacity-70 transition-opacity"
        style={{ color: 'var(--ink-muted)' }}>
        <span style={{ display: 'inline-block', transform: open ? 'rotate(90deg)' : 'none', transition: 'transform 0.2s' }}>›</span>
        TECH SPECS
      </button>
      {open && (
        <p className="font-mono text-xs leading-relaxed" style={{ color: 'var(--ink-muted)', marginTop: '0.75rem', paddingLeft: '1rem', borderLeft: '1px solid rgba(0,0,0,0.15)' }}>
          {tech}
        </p>
      )}
    </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-cream-dark rounded-3xl p-10">
            ...
            <p className="font-sans text-lg leading-relaxed mb-4" style={{ color: '#C8BFB0' }}>
              The Ritual Profile accumulates every answer you have ever given — across all four apps. The first quiz populates it. Every one after makes it richer.
            </p>
            <p className="font-sans text-base leading-relaxed" style={{ color: '#9A8B7A' }}>
              One button sends the whole profile to Gemini 2.5 Flash and generates a prose study of who you are right now. Saved so it does not regenerate every time you open it.
            </p>
          </div>
      ...
      <div className="px-6 md:px-16 max-w-5xl mx-auto">
        <div className="bg-cream-alt rounded-3xl p-10 md:p-16 text-center">
          ...
          <p className="font-sans text-xl text-ink-muted leading-relaxed max-w-2xl mx-auto mb-6">
            Every feature has a rule-based default. AI adds a narrative layer when you want it. The apps work without hitting the API, load instantly, and do not fail silently.
          </p>
