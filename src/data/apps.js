export const SUITE = [
  ...
  },
  {
    ...
    desc: 'Your ritual life, at a glance. One dashboard that pulls your data from every Ritualware app — style, beauty, neighborhood, wealth, studio — in one place.',
    domain: 'robin.ritualware.app',
    href: 'https://robin.ritualware.app',
    health: 'https://robin.ritualware.app/health.json',
    statusDesc: 'Dashboard',
    color: '#A0896E',
    bg: 'rgba(160,137,110,0.08)',
